...
```
3. Download this zip file ([spaces-renamer.zip](https://github.com/user-attachments/files/16669834/spaces-renamer.zip)). It contains the SpacesRenamer app, spaces-renamer.bundle (1.11.0), and MacForge (an unofficial 1.2.0 Beta 2). **If you're on version macOS 14.4+** you should use [spaces-renamer.zip](https://github.com/user-attachments/files/16669857/spaces-renamer.zip) instead, which has MacForge 1.2.2 (3) and should work. You can also try this on non-M1/M2/Apple Silicon Macs.
